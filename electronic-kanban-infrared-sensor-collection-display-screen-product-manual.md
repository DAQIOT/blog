<https://zhuanlan.zhihu.com/p/2018284108472693159>
As a professional provider of IoT data acquisition solutions and an expert in industrial IoT data acquisition, the editor of Shanghai Data Acquisition IOT Technology Co., Ltd， (daq-iot) hereby presents the following introduction, and sincerely welcomes discussions and exchanges.
Supported Communication Interfaces: CAN, RS485, Mbus, 4–20mA, Profibus, CC-Link, HART, digital I/O, etc.
Industrial Protocols: Modbus RTU/TCP, HJ212, IEC104, DLT645, DLMS, IEC61850, MQTT, etc.
Mail:export@daq-iot.com
## **1** **Product Overview**
![图片](https://dev-to-uploads.s3.us-east-2.amazonaws.com/uploads/articles/p20iceo29uo0m61861e2.jpg)
this[electronic display board](https://zhida.zhihu.com/search?content_id=271754100&content_type=Article&match_order=1&q=%E7%94%B5%E5%AD%90%E7%9C%8B%E6%9D%BF&zhida_source=entity)It is designed byReal-timeTechnology Co., Ltd. specifically for the visual management of workshop production lines[LED high brightness dot matrix screen](https://zhida.zhihu.com/search?content_id=271754100&content_type=Article&match_order=1&q=LED%E9%AB%98%E4%BA%AE%E7%82%B9%E9%98%B5%E5%B1%8F&zhida_source=entity)Display, equipped with infrared Sensor to automatically collect actual production, supports production model input, planning/Real-time target production setting, production cycle monitoring, automatic completion rate calculation, data power-off maintenance, suitable for various manufacturing workshop assembly lines and single machine capacity monitoring.
...
Communication Protocol:[Modbus-RTU](https://zhida.zhihu.com/search?content_id=271754100&content_type=Article&match_order=1&q=Modbus-RTU&zhida_source=entity)/TCP (default), supports user customizationProtocol
...
Protection level:[IP54](https://zhida.zhihu.com/search?content_id=271754100&content_type=Article&match_order=1&q=IP54&zhida_source=entity)(Indoor)
...
(6) Core function: Improve production efficiency, optimize management system, help factories achieve production management, support customized production, simple operation, and provide five-year warranty.
...
Customization cycle: 7-15 working days, providing Protocol documentation and testing tools.
**7 Platform Integration**
**7.1 Default Platform**
L docking platform: the company's self-developed production management platform（[ProMan](https://zhida.zhihu.com/search?content_id=271754100&content_type=Article&match_order=1&q=ProMan&zhida_source=entity)）
...
**8 Precautions**
(1) Installation, wiring, and maintenance must be carried out by professional electricians, and live working is strictly prohibited.
...
(5) Long term shutdown with power cut off to prevent moisture and dust.
(6) Do not disassemble or modify by yourself, otherwise the warranty will be lost.
(7) If there is smoke, odor, or abnormal noise, immediately cut off the power and contact our company's after-sales service.